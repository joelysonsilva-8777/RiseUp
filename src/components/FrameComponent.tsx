...
const FrameComponent: FunctionComponent<FrameComponentType> = ({
  ...
  return (
    <section
      className={`self-stretch flex items-start !pt-0 !pb-0 !pl-[21px] !pr-0 box-border max-w-full text-left text-[11px] text-[#01122f] font-[Montserrat] ${className}`}
      style={frameSectionStyle}
    >
      <div className="h-[331px] flex-1 relative max-w-full mq1275:h-auto mq1275:min-h-[331px]">
        ...
        <div className="absolute top-[34px] left-[0px] w-[1273px] flex items-end gap-[27px] max-w-full mq1275:flex-wrap">
        ...
        <div className="absolute top-[198px] left-[0px] w-full flex items-start gap-[21px] max-w-full text-sm mq1275:flex-wrap">
          ...
          <div className="flex-1 flex flex-col items-start !pt-[5px] !pb-0 !pl-0 !pr-0 box-border min-w-[408px] max-w-full mq750:min-w-full">
            <div className="self-stretch flex items-start gap-[21px] mq750:flex-wrap">
              <div className="flex-1 flex flex-col items-start !pt-0 !pb-0 !pl-0 !pr-[15px] box-border min-w-[131px]">
        ...
        <div className="absolute top-[260px] left-[0px] w-full flex flex-col items-start max-w-full text-[#8694aa]">
          ...
          <div className="self-stretch flex items-start gap-[27px] !mt-[-8px] relative text-base text-[#01122f] mq1275:flex-wrap">
        ...
        <div className="absolute top-[309px] left-[0px] w-full flex items-start gap-[27px] max-w-full text-[#1e1e1e] mq1275:flex-wrap">
